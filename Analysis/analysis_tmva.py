...
for branch in signal.GetListOfBranches():
    if "1" in branch.GetName():
        ...
        continue
dataloader.AddSignalTree(signal, 1.0) #weight_mc
dataloader.AddBackgroundTree(background, 1.0)

selcut ='!TMath::IsNaN(n_jet)'

dataloader.PrepareTrainingAndTestTree(ROOT.TCut(selcut),"nTrain_Signal=70000:nTrain_Background=70000:nTest_Signal=30000:nTest_Background=30000:SplitMode=Random:!V:NormMode=NumEvents:MixMode=Random" );


factory.BookMethod(dataloader, ROOT.TMVA.Types.kBDT, "BDT",'!H:!V:VarTransform=Norm:NTrees=200:MinNodeSize=1%:MaxDepth=7:BoostType=Grad:SeparationType=GiniIndex')#:AdaBoostBeta=0.5:UseBaggedBoost:BaggedSampleFraction=0.5:SeparationType=GiniIndex:nCuts=2:Shrinkage=0.10')
